...
extern u8 gUnk_080F3010[];
extern u32 vtable_unk_080E6CD8[];
...
EC void *func_08036530(void *self, void *game_object, void *npc, u32 arg_3)
{
    __10ANpcEntityP10GameObjectP3NpcUiPCvUiUiUi(
        self, game_object, npc, arg_3,
        gUnk_080F3010, 0x320, 0x324, 0x3e6);
    *(void **)((u8 *)self + 0x14) = vtable_unk_080E6CD8;
    return self;
}
