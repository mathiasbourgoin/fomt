...
extern u8 gUnk_080F1FC0[];
extern u32 vtable_unk_080E7118[];
...
EC void *func_08035BC8(void *self, void *game_object, void *npc, u32 arg_3)
{
    __10ANpcEntityP10GameObjectP3NpcUiPCvUiUiUi(
        self, game_object, npc, arg_3,
        gUnk_080F1FC0, 0x22f, 0x233, 0x3e1);
    *(void **)((u8 *)self + 0x14) = vtable_unk_080E7118;
    return self;
}
