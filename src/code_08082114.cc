// func_08082114 (0x08082114) -- constructor sibling of the "richer" 2-child
...
extern u32 vtable_unk_080E7CD8[];

EC void *func_08081ACC(void *self, void *a2);

EC void *func_08082114(void *self, void **a1, void *a2)
{
    *(void **)self = vtable_unk_080E7CD8;
    void *obj = operator new(0x6b0);
    obj = func_08081ACC(obj, a2);
