// func_0808C56C (0x0808C56C) -- constructor sibling of the "richer" 2-child
...
extern u32 vtable_unk_080E7D74[];

EC void *func_0808ABC4(void *self, void *a2);

EC void *func_0808C56C(void *self, void **a1, void *a2)
{
    *(void **)self = vtable_unk_080E7D74;
    void *obj = operator new(0x10c);
    obj = func_0808ABC4(obj, a2);
