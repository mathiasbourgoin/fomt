// func_0806D918 (0x0806D918) -- another member of the "~37 richer
// destructors" family (DECOMP_RULES.md / SESSION_NOTES.md round 4-6),
// identical shape to func_080B3C0C/func_080C7ED0/func_080BC8C0: vtable
...
EC void func_0806D918(void *self_v, int in_chrg)
{
    SelfFields *self = (SelfFields *)self_v;
    self->vt = vtable_unk_080E7AB4;
