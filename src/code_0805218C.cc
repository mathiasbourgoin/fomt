// func_0805218C (0x0805218C) -- constructor sibling of the "richer" 2-child
...
extern u32 vtable_unk_080E7934[];

EC void *func_0805143C(void *self, void *a2);

EC void *func_0805218C(void *self, void **a1, void *a2)
{
    *(void **)self = vtable_unk_080E7934;
    void *obj = operator new(0x8c0);
    obj = func_0805143C(obj, a2);
