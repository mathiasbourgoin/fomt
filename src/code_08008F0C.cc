// func_08008F0C (0x08008F0C) -- DMA descriptor builder, one of the 13
// opaque callees of franglais_transition_impl_tick (SESSION_NOTES.md
// round w90 sect. 0, called x6 from that body; the function right before
// it in the original asm ends on a literal 0x040000D4 = DMA3SAD, and w80
// already characterized this family as the VRAM DMA mechanism of the
// transition).
//
...
//
// Matching notes (round w91 -- resolves the w90 near-miss, the
// systematic extra `adds r1, rX, #0` before the first orrs, cf.
// SESSION_NOTES round w90 sect. 3). Two source-shape details, no
// semantic change:
