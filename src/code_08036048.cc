...
extern u8 gUnk_080F4D74[];
extern u32 vtable_unk_080E6ED8[];
...
EC void *func_08036048(void *self, void *game_object, void *npc, u32 arg_3)
{
    __10ANpcEntityP10GameObjectP3NpcUiPCvUiUiUi(
        self, game_object, npc, arg_3,
        gUnk_080F4D74, 0x813, 0x817, 0x3f6);
    *(void **)((u8 *)self + 0x14) = vtable_unk_080E6ED8;
    return self;
}
