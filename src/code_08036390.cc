...
extern u8 gUnk_080F3FD8[];
extern u32 vtable_unk_080E6D58[];
...
EC void *func_08036390(void *self, void *game_object, void *npc, u32 arg_3)
{
    __10ANpcEntityP10GameObjectP3NpcUiPCvUiUiUi(
        self, game_object, npc, arg_3,
        gUnk_080F3FD8, 0x6c5, 0x6c9, 0x3f1);
    *(void **)((u8 *)self + 0x14) = vtable_unk_080E6D58;
    return self;
}
