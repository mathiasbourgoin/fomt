// func_080925C4 (0x080925C4) -- another member of the "~37 richer
...
extern u32 vtable_unk_080E7DC8[];
...
EC void func_080925C4(void *self_v, int in_chrg)
{
    SelfFields *self = (SelfFields *)self_v;
    self->vt = vtable_unk_080E7DC8;
