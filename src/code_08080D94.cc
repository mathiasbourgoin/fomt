// func_08080D94 (0x08080D94) -- constructor sibling of the "richer" 2-child
...
extern u32 vtable_unk_080E7CA0[];

EC void *func_080804F8(void *self, void *a2);

EC void *func_08080D94(void *self, void **a1, void *a2)
{
    *(void **)self = vtable_unk_080E7CA0;
    void *obj = operator new(0x710);
    obj = func_080804F8(obj, a2);
