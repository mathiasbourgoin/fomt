...
extern u8 gUnk_080F3408[];
extern u32 vtable_unk_080E6D98[];
...
EC void *func_08036328(void *self, void *game_object, void *npc, u32 arg_3)
{
    __10ANpcEntityP10GameObjectP3NpcUiPCvUiUiUi(
        self, game_object, npc, arg_3,
        gUnk_080F3408, 0x689, 0x68d, 0x3ef);
    *(void **)((u8 *)self + 0x14) = vtable_unk_080E6D98;
    return self;
}
