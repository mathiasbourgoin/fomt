...
extern u8 gUnk_080F59CC[];
extern u32 vtable_unk_080E6E98[];
...
EC void *func_08036184(void *self, void *game_object, void *npc, u32 arg_3)
{
    __10ANpcEntityP10GameObjectP3NpcUiPCvUiUiUi(
        self, game_object, npc, arg_3,
        gUnk_080F59CC, 0x85f, 0x863, 0x3f9);
    *(void **)((u8 *)self + 0x14) = vtable_unk_080E6E98;
    return self;
}
