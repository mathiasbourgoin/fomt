// func_0808AB38 (0x0808AB38) -- constructor sibling of the "richer" 2-child
...
extern u32 vtable_unk_080E7D58[];

EC void *func_080882AC(void *self, void *a2);

EC void *func_0808AB38(void *self, void **a1, void *a2)
{
    *(void **)self = vtable_unk_080E7D58;
    void *obj = operator new(0x10c);
    obj = func_080882AC(obj, a2);
