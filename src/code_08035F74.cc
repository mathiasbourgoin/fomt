...
extern u8 gUnk_080F49C0[];
extern u32 vtable_unk_080E6F58[];
...
EC void *func_08035F74(void *self, void *game_object, void *npc, u32 arg_3)
{
    __10ANpcEntityP10GameObjectP3NpcUiPCvUiUiUi(
        self, game_object, npc, arg_3,
        gUnk_080F49C0, 0x80b, 0x80f, 0x3f5);
    *(void **)((u8 *)self + 0x14) = vtable_unk_080E6F58;
    return self;
}
