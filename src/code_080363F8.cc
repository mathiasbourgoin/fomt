...
extern u8 gUnk_080F35E4[];
extern u32 vtable_unk_080E6D18[];
...
EC void *func_080363F8(void *self, void *game_object, void *npc, u32 arg_3)
{
    __10ANpcEntityP10GameObjectP3NpcUiPCvUiUiUi(
        self, game_object, npc, arg_3,
        gUnk_080F35E4, 0x691, 0x695, 0x3f0);
    *(void **)((u8 *)self + 0x14) = vtable_unk_080E6D18;
    return self;
}
