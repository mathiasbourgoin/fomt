...
extern u8 gUnk_080F5D94[];
extern u32 vtable_unk_080E6C98[];
...
EC void *func_08036590(void *self, void *game_object, void *npc, u32 arg_3)
{
    __10ANpcEntityP10GameObjectP3NpcUiPCvUiUiUi(
        self, game_object, npc, arg_3,
        gUnk_080F5D94, 0x884, 0x888, 0x3fa);
    *(void **)((u8 *)self + 0x14) = vtable_unk_080E6C98;
    return self;
}
