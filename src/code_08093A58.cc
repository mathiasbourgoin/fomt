// func_08093A58 (0x08093A58) -- constructor sibling of the "richer" 2-child
...
extern u32 vtable_unk_080E8018[];

EC void *func_0809323C(void *self, void *a2);

EC void *func_08093A58(void *self, void **a1, void *a2)
{
    *(void **)self = vtable_unk_080E8018;
    void *obj = operator new(0x3f0);
    obj = func_0809323C(obj, a2);
