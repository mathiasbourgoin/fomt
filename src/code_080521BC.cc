// func_080521BC (0x080521BC) -- another member of the "~37 richer
...
// unchanged -- identical shape to func_0809A518.
#include "prelude.h"
...
EC void func_080521BC(void *self_v, int in_chrg)
{
    SelfFields *self = (SelfFields *)self_v;
    self->vt = vtable_unk_080E7934;
