...
extern u8 gUnk_080F4974[];
extern u32 vtable_unk_080E6B98[];
...
EC void *func_08036860(void *self, void *game_object, void *npc, u32 arg_3)
{
    __10ANpcEntityP10GameObjectP3NpcUiPCvUiUiUi(
        self, game_object, npc, arg_3,
        gUnk_080F4974, 0x7f2, 0x7f6, 0x3f4);
    *(void **)((u8 *)self + 0x14) = vtable_unk_080E6B98;
    return self;
}
