...
extern u8 gUnk_080F6B10[];
extern u32 vtable_unk_080E6958[];
...
EC void *func_08036DC4(void *self, void *game_object, void *npc, u32 arg_3)
{
    __10ANpcEntityP10GameObjectP3NpcUiPCvUiUiUi(
        self, game_object, npc, arg_3,
        gUnk_080F6B10, 0x8d8, 0x8dc, 0x3fe);
    *(void **)((u8 *)self + 0x14) = vtable_unk_080E6958;
    return self;
}
