// func_080B3C0C (0x080B3C0C) -- another member of the "~23 richer
// destructors" family (DECOMP_RULES.md / SESSION_NOTES.md round 4-5),
// identical shape to func_080C7ED0/func_080BC8C0 (this round): vtable
...
EC void func_080B3C0C(void *self_v, int in_chrg)
{
    SelfFields *self = (SelfFields *)self_v;
    self->vt = vtable_unk_080E850C;
