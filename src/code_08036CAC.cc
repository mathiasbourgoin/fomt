...
extern u32 vtable_unk_080E6A18[];
...
EC void *func_08036CAC(void *self, void *game_object, void *npc, u32 arg_3)
{
    __10ANpcEntityP10GameObjectP3NpcUiPCvUiUiUi(
        self, game_object, npc, arg_3,
        nullptr, 0x679, 0x67d, 0);
    *(void **)((u8 *)self + 0x14) = vtable_unk_080E6A18;
    return self;
}
