// func_08083AEC (0x08083AEC) -- another member of the "~37 richer
...
extern u32 vtable_unk_080E7D04[];
...
EC void func_08083AEC(void *self_v, int in_chrg)
{
    SelfFields *self = (SelfFields *)self_v;
    self->vt = vtable_unk_080E7D04;
