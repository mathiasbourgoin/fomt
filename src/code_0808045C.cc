// func_0808045C (0x0808045C) -- constructor sibling of the "richer" 2-child
...
extern u32 vtable_unk_080E7C84[];

EC void *func_0807F63C(void *self, void *a2);

EC void *func_0808045C(void *self, void **a1, void *a2)
{
    *(void **)self = vtable_unk_080E7C84;
    void *obj = operator new(0x710);
    obj = func_0807F63C(obj, a2);
