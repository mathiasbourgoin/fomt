// func_0808ECD8 (0x0808ECD8) -- constructor sibling of the "richer" 2-child
...
EC void *func_0808C5F8(void *self, void *a2);

EC void *func_0808ECD8(void *self, void **a1, void *a2)
{
    *(void **)self = vtable_unk_080E7D90;
    void *obj = operator new(0x10c);
    obj = func_0808C5F8(obj, a2);
