// func_080755EC (0x080755EC) -- constructor sibling of the "richer" 2-child
...
extern u32 vtable_unk_080E7B4C[];

EC void *func_08070B70(void *self, void *a2);

EC void *func_080755EC(void *self, void **a1, void *a2)
{
    *(void **)self = vtable_unk_080E7B4C;
    void *obj = operator new(0x17c);
    obj = func_08070B70(obj, a2);
