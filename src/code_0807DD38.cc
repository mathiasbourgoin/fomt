// func_0807DD38 (0x0807DD38) -- constructor sibling of the "richer" 2-child
...
extern u32 vtable_unk_080E7C30[];

EC void *func_0807D194(void *self, void *a2);

EC void *func_0807DD38(void *self, void **a1, void *a2)
{
    *(void **)self = vtable_unk_080E7C30;
    void *obj = operator new(0x710);
    obj = func_0807D194(obj, a2);
