...
extern u8 gUnk_080F2DC0[];
extern u32 vtable_unk_080E6A98[];
...
EC void *func_08036B4C(void *self, void *game_object, void *npc, u32 arg_3)
{
    __10ANpcEntityP10GameObjectP3NpcUiPCvUiUiUi(
        self, game_object, npc, arg_3,
        gUnk_080F2DC0, 0x318, 0x31c, 0x3e5);
    *(void **)((u8 *)self + 0x14) = vtable_unk_080E6A98;
    return self;
}
