...
extern u8 gUnk_080F5540[];
extern u32 vtable_unk_080E6F18[];
...
EC void *func_08035FE0(void *self, void *game_object, void *npc, u32 arg_3)
{
    __10ANpcEntityP10GameObjectP3NpcUiPCvUiUiUi(
        self, game_object, npc, arg_3,
        gUnk_080F5540, 0x84b, 0x84f, 0x3f7);
    *(void **)((u8 *)self + 0x14) = vtable_unk_080E6F18;
    return self;
}
