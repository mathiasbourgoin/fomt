...
.L080124BE:
    ...
    .section .text.tail080124D0, "ax", %progbits
...
.L0801275C:
	...
	.section .text.tail08012760, "ax", %progbits
...
.L0801279C:
	...
	.section .text.tail080127A0, "ax", %progbits
...
.L0801285C:
	...
	.section .text.tail08012860, "ax", %progbits
...
func_08012BAC: @ 0x08012BAC
    ...
    .endif
    .section .text.tail08012BBC, "ax", %progbits
...
.section .text.tail0801A054, "ax", %progbits
...
.section .text.tail0801A13C, "ax", %progbits
...
.L0801D9B8: .4byte 0x00001054
	...
	.section .text.tail0801D9BC, "ax", %progbits
.L0801D9BC:
...
.L0801DB54: .4byte 0x00001054
	...
	.section .text.tail0801DB58, "ax", %progbits
