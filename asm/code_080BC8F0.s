	...
	thumb_func_start func_080BC8F0
func_080BC8F0: @ 0x080BC8F0
	push {lr}
	ldr r0, [r0, #4]
	bl func_080B44E0
	pop {r1}
...
.L080C0D40: .4byte vtable_unk_080E8544
	...
	thumb_func_start func_080C0D44
func_080C0D44: @ 0x080C0D44
	push {r4, r5, lr}
	adds r4, r0, #0
	adds r5, r1, #0
	ldr r0, .L080C0D70 @ =vtable_unk_080E8544
	str r0, [r4]
	ldr r1, [r4, #4]
	cmp r1, #0
	beq .L080C0D60
...
.L080C0D60:
	...
	bx r0
	.align 2, 0
.L080C0D70: .4byte vtable_unk_080E8544

	thumb_func_start func_080C0D74
func_080C0D74: @ 0x080C0D74
	push {lr}
	ldr r0, [r0, #4]
	bl func_080BCCD4
	pop {r1}
	...
	thumb_func_start func_080C0D80
func_080C0D80: @ 0x080C0D80
	ldr r0, [r0, #4]
	ldr r1, .L080C0D8C @ =0x00000604
	adds r0, r0, r1
	ldr r0, [r0]
	bx lr
	.align 2, 0
.L080C0D8C: .4byte 0x00000604
...
.L080C14B8: .4byte 0x00000814
	...
	thumb_func_start func_080C14BC
func_080C14BC: @ 0x080C14BC
	push {lr}
	bl func_08008724
	pop {r0}
	bx r0
