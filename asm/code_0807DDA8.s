...
func_0807DDC4: @ 0x0807DDC4
	...
	adds r5, r2, #0
	bl func_080C7F58
	ldr r0, .L0807DDF0 @ =vtable_unk_080E7C08
	str r0, [r4, #4]
	ldr r1, .L0807DDF4 @ =0x000006A4
	adds r0, r4, r1
	str r5, [r0]
	movs r2, #0xd5
	lsls r2, r2, #3
	...
	bx r1
	.align 2, 0
.L0807DDF0: .4byte vtable_unk_080E7C08
...
func_0807E438: @ 0x0807E438
	...
	adds r5, r2, #0
	adds r6, r3, #0
	ldr r0, .L0807E474 @ =vtable_unk_080E7C20
	str r0, [r4]
	movs r0, #0xe2
	lsls r0, r0, #3
	bl __builtin_new
	...
	bx r1
	.align 2, 0
.L0807E474: .4byte vtable_unk_080E7C20
.L0807E478:
...
func_08081ACC: @ 0x08081ACC
	...
	adds r4, r0, #0
	bl func_080C7F58
	ldr r0, .L08081AF8 @ =vtable_unk_080E7CCC
	str r0, [r4, #4]
	ldr r1, .L08081AFC @ =0x000006A4
	adds r0, r4, r1
	movs r1, #0
	str r1, [r0]
	movs r2, #0xd5
	...
	bx r1
	.align 2, 0
.L08081AF8: .4byte vtable_unk_080E7CCC
.L08081AFC: .4byte 0x000006A4
...
func_08081B00: @ 0x08081B00
	...
	adds r4, r0, #0
	adds r5, r1, #0
	ldr r0, .L08081B24 @ =vtable_unk_080E7CCC
	str r0, [r4, #4]
	ldr r1, .L08081B28 @ =0x000006AC
	adds r0, r4, r1
	ldr r0, [r0]
	bl __builtin_delete
	adds r0, r4, #0
	...
	bx r0
	.align 2, 0
.L08081B24: .4byte vtable_unk_080E7CCC
.L08081B28: .4byte 0x000006AC

	thumb_func_start func_08081B2C
func_08081B2C: @ 0x08081B2C
	ldr r2, .L08081B3C @ =0x000006AC
	adds r1, r1, r2
	ldr r3, [r1]
	movs r2, #0
	str r2, [r1]
