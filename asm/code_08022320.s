...
.L080229B2:
	...
	.section .text.tail080229B8, "ax", %progbits
.L080229B8:
	...
	.section .text.tail08022B5C, "ax", %progbits
	.if 0
...
.L08022B6C:
	...
	.section .text.tail08022B70, "ax", %progbits
.L08022B70:
...
.L0802340E:
	...
	.section .text.tail08023414, "ax", %progbits
.L08023414:
...
.L08023800:
	...
	.section .text.tail08023804, "ax", %progbits
	.if 0
...
.L0802381C:
	...
	.section .text.tail08023820, "ax", %progbits
.L08023820:
...
.L080240CA:
	...
	.section .text.tail080240D0, "ax", %progbits
.L080240D0:
...
.L080244D4:
	...
	.section .text.tail080244D8, "ax", %progbits
	.if 0
...
.L080244E8:
	...
	.section .text.tail080244EC, "ax", %progbits
.L080244EC:
...
.L0802C228:
    ...
    .section .text.tail0802C2E0, "ax", %progbits
